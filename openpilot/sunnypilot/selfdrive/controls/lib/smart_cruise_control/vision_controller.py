...
# The 3.0 (MAX_LATERAL_ACCEL_NO_ROLL) breakpoint brakes at -1.5: stronger, slightly earlier braking
# ramping into the no-roll lateral limit before the -3.5 hard limit at 3.6. Keep the sign NEGATIVE
# (monotonic braking) -- a positive value here would command acceleration mid-corner.
